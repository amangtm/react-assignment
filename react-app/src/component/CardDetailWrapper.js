                    ...
                    <div className="detail-col">
                        ...
                        <div className="detail-row">
                            ...
                            {topLevelDomain.map(domain=> {
                                return <span style={{color: state.theme.input}}>{domain}</span>
                            })} 
                        </div>
                        <div className="detail-row">
                            <h4 className="detail-sub-heading">Currencies:</h4>
                            {currencies.map(currency=> {
                                return <span style={{color: state.theme.input}}>{currency.name}</span>
                            })}  
                        </div>
                        <div className="detail-row">
                            <h4 className="detail-sub-heading">Languages:</h4>
                            {languages.map(lang=> {
                                return <span style={{color: state.theme.input}}>{lang.name}</span>
                            })} 
                        </div>
                    ...
                    <div className="detail-clickable-row">
                        ...
                        <div className="border-country-list">
                            {borderCountries.map(name =>{
                                return  <button id={name} style={{color: state.theme.input, backgroundColor: state.theme.element}}>{name}</button>
                            })}   
                        </div>
